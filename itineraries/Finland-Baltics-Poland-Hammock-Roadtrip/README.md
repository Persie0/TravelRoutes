...
- **Sleeping:** **hammock + tarp + bug net is the default**, car only as weather/gear backup. In ordinary Finnish forest, temporary camping is broadly allowed under Everyman's Rights; national parks/protected areas can restrict camping, so local park rules win.
...
- [Hammock / wild-sleeping guide](hammock-and-wild-camping.md)
...
- [Route GeoJSON](maps/route.geojson)
- [Sight data](data/sights.csv)

## Map method
The SVG maps are built from WGS84 stop coordinates and real GSHHS/Basemap coastlines and borders. Route lines are explicit planning connectors unless exact routed geometry is available; ferry and rail legs are encoded separately from road legs.